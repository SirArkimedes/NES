...
extension SubscriptionListViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.configure(with: SubscriptionTableViewCell.ViewModel(title: sub.name, cost: sub.cost, backgroundColor: color, emoji: sub.emojiIcon, occurenceCycle: .year, occurencePeriod: 2))
